...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_user_locations_id"), "user_locations", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_user_locations_is_current"),
        "user_locations",
        ["is_current"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["location_id"], ["user_locations.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_location_history_created_at"),
        "location_history",
        ["created_at"],
        unique=False,
    )
